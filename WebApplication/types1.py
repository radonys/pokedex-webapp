...
<html>
<title>Types of Pokemon (by type) - Pokedex</title>
...
<body>
  <div class="jumbotron text-center">
    ...
    <p>18 types of Pokemon exist with 324 ways to assign them</p> 
  </div>

<div class="container-fluid">
  <h2>Search by Type</h2><br>
  <form action="/cgi-bin/DBMS_Project/types1.py" method="post">
    <div class="form-group">
    <label for="pokemon_name">Type :</label><br><br>
...
#sql = "select species,type1,type2 from Types,Pokemon_Species where Types.id = Pokemon_Species.id and species = '"+(str1)+"';"
sql = "select species,type1,type2 from Types INNER JOIN Pokemon_Species on Types.id = Pokemon_Species.id where Types.type1 = '"+(str1)+"' UNION ( select species,type1,type2 from Types INNER JOIN Pokemon_Species on Types.id = Pokemon_Species.id where Types.type2 = '"+(str1)+"');"
...
<div class="container-fluid bg-grey">
  <h3>Want to search by Pokemon ?</h3>
  <a href="/cgi-bin/DBMS_Project/types.py" class="btn btn-default btn-lg">Click Here</a>
  <h6 align="right">The search uses Inner Join.</h6>
