...
<html>
<title>Statistics (Moves) - Pokedex</title>
...
<div class="container-fluid">
  ...
  <form action="/cgi-bin/DBMS_Project/moves.py" method="post">
...
sql = "select m.species,p.move,p.power,p.accuracy from types z left join move p on p.type=z.type1 left join pokemon_species m on z.id=m.id where  m.species = '"+(str1)+"' UNION ALL select m.species,p.move,p.power,p.accuracy from types z right join move p on p.type=z.type2 right join pokemon_species m on z.id=m.id where  m.species = '"+(str1)+"';"
...
<div class="container-fluid bg-grey">
    <h3>Want to search about characteristics ?</h3>
  <a href="/cgi-bin/DBMS_Project/statistics.py" class="btn btn-default btn-lg">Click Here</a>
  <h6 align="right">The search uses Full Outer Join.</h6>
