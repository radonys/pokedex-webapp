...
<html>
<title>Stamina & Power of Pokemons - Pokedex</title>
...
<body>
  <div class="jumbotron text-center">
    <h1>Stamina & Power of Pokemon</h1> 
    <p>Counts the most for gym battles</p> 
  </div>

<div class="container-fluid">
  <h2>Search by Pokemon</h2><br>
  <form action="/cgi-bin/DBMS_Project/health.py" method="post">
...
sql = "select species,hp,attack,defense from Pokemon_Species RIGHT JOIN Health_Power ON Pokemon_Species.id = Health_Power.id where Pokemon_Species.species =  '"+(str1)+"';"
...
<div class="container-fluid bg-grey">
  <h6 align="right">The search uses Right Join.</h6>
