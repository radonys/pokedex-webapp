...
<html>
<title>Types of Pokemon (by name) - Pokedex</title>
...
<div class="container-fluid">
  ...
  <form action="/cgi-bin/DBMS_Project/types.py" method="post">
...
<div class="container-fluid bg-grey">
  <h3>Want to search by type ?</h3>
  <a href="/cgi-bin/DBMS_Project/types1.py" class="btn btn-default btn-lg">Click Here</a>
  <h6 align="right">The search uses Cartesian Join.</h6>
