...
<body>
  <div class="jumbotron text-center">
    <h1>Pokemon IDs</h1> 
    <p>Key to the Pokedex</p> 
  </div>

<div class="container-fluid">
  <h2>Search by Pokemon</h2><br>
  <form action="/cgi-bin/DBMS_Project/procedure.py" method="post">
...
<h6 align="right">Uses procedures.</h6>
